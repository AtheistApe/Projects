...
def draw_text(surf, text, size, x, y):
    ...
    # 'True' parameter below asks for font to be 'anti-aliased'
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.power = 1 # Number of bullets to shoot
    ...
    def hide(self): # Hide the player temoprarily
        self.hidden = True
        self.hide_timer = pygame.time.get_ticks()
        self.rect.center = (WIDTH / 2, HEIGHT + 200) # Move ship offscreen
...
player_die_sound = pygame.mixer.Sound(os.path.join(snd_dir, 'rumble1.wav'))
pygame.mixer.music.load(os.path.join(snd_dir, 'tgfcoder-FrozenJam-SeamlessLoop.wav'))
pygame.mixer.music.set_volume(0.4)

pygame.mixer.music.play(loops=-1) # '-1' means music will continuously loop.
# Game loop
game_over = True
running = True
while running:
