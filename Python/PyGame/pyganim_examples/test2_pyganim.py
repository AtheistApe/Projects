...
while True:
    ...
    elapsedSurf = BASICFONT.render(
        'Elapsed: %s' % boltAnim.elapsed, True, WHITE)
    ...
    curFrameSurf = BASICFONT.render(
        'Cur Frame Num: %s' % boltAnim.currentFrameNum, True, WHITE)
    ...
    playTimeSurf = BASICFONT.render(
        'Play Start Time: %s' % boltAnim._playingStartTime, True, WHITE)
    ...
    pauseTimeSurf = BASICFONT.render(
        'Pause Start Time: %s' % boltAnim._pausedStartTime, True, WHITE)
    ...
    diffTimeSurf = BASICFONT.render(
        'Play - Pause Time: %s' % (boltAnim._playingStartTime - boltAnim._pausedStartTime), True, WHITE)
    ...
    diff2TimeSurf = BASICFONT.render(
        'Current - Play Time: %s' % (rightNow - boltAnim._playingStartTime), True, WHITE)
    ...
    diff3TimeSurf = BASICFONT.render(
        'Current - Pause Time: %s' % (rightNow - boltAnim._pausedStartTime), True, WHITE)
