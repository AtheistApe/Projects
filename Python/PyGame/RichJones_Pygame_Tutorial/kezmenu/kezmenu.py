...
class KezMenu(KezMenuEffectAble):
    ...
    def __init__(self, *options):
        ...
        # The 2 lines below seem stupid, but for effects I can need different
        # font for every line.
        try:
            self._font = None
            self.font = pygame.font.Font(None, 32)
            self._fixSize()
        # needed for fixing the common issues if the module is used in a py2exe
        # app
        except:
            pass
    ...
    def draw(self, surface):
        ...
        for o in self.options:
            ...
            o['label_rect'] = pygame.Rect(
                (ol + self.x + indent, ot + self.y + offset), (ren.get_width(), ren.get_height()))
    ...
    position = property(lambda self: (
        self.x, self.y), _setPosition, doc="""The menu position inside the container""")
    ...
    def _setFont(self, font):
        ...
        self._fixSize()
    font = property(
        lambda self: self._font, _setFont, doc="""Font used by the menu""")
